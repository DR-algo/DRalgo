...
AppendTo[testList,
TestCreate[solWithoutA6,
	{\[Alpha][F^3]->-(2/45) I (3 gs^3 Sqrt[T] Zb[3,0]-gs^3 Sqrt[T] Zf[3,0]),\[Alpha][A^2 F^2,1]->-(2/405) (1971 gs^4 Zb[3,0]-37 gs^4 Zf[3,0]),\[Alpha][A^2 F^2,2]->-(2/405) (999 gs^4 Zb[3,0]-23 gs^4 Zf[3,0]),\[Alpha][A^2 F^2,3]->0,\[Alpha][A^4 D^2,1]->1/81 (-1215 gs^4 T Zb[3,0]+54 gs^4 T xi Zb[3,0]-27 gs^4 T xi^2 Zb[3,0]+8 gs^4 T Zf[3,0]),\[Alpha][A^4 D^2,2]->1/81 (-1161 gs^4 T Zb[3,0]-54 gs^4 T xi Zb[3,0]+27 gs^4 T xi^2 Zb[3,0]+40 gs^4 T Zf[3,0]),\[Alpha][A^4 D^2,3]->0,\[Alpha][D^2 F^2]->1/180 (333 gs^2 Zb[3,0]-90 gs^2 xi Zb[3,0]-15 gs^2 xi^2 Zb[3,0]-16 gs^2 Zf[3,0]),\[Alpha][A^2 D^2 F]->-(1/90) I (-267 gs^3 Sqrt[T] Zb[3,0]+30 gs^3 Sqrt[T] xi Zb[3,0]+15 gs^3 Sqrt[T] xi^2 Zb[3,0]+14 gs^3 Sqrt[T] Zf[3,0]),\[Alpha][A^2 D^4]->1/180 (159 gs^2 Zb[3,0]+90 gs^2 xi Zb[3,0]-45 gs^2 xi^2 Zb[3,0]-8 gs^2 Zf[3,0])}
]];


AppendTo[testList,
TestCreate[ODIM6[1,3][[1,2,3]],
	1/15 gs^3 Sqrt[T] (3 Zb[3,0]-Zf[3,0])
]];

AppendTo[testList,
TestCreate[ODIM6[8,3][[1,1,1,1]],
