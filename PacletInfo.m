...
PacletObject[
  <|
    ...
    "URL" -> "\!\(\*TemplateBox[{PaneSelectorBox[{False -> \"\\\"github.com/DR-algo/DRalgo\\\"\", True -> StyleBox[\"\\\"github.com/DR-algo/DRalgo\\\"\", StripOnInput -> False]}, Dynamic[CurrentValue[\"MouseOver\"]], ImageSize -> Automatic, FrameMargins -> 0], \"https://github.com/DR-algo/DRalgo\"},\n\"HyperlinkURL\"]\)",
    "Icon" -> "FrontEnd/logo.png",
    "License" -> "GPL-3.0+",
    "PublisherID" -> "DRalgo",
    "Category" -> "Physics",
    "Keywords" -> {"cosmology","phase transitions","gravitational waves","thermal potential","scalar potential","BSM"},
    "PrimaryContext" -> "DRalgo`DRalgo`",
    "Extensions" -> {
      {
        "Kernel",
        "Root" -> "Kernel",
